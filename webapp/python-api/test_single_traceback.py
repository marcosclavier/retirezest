#!/usr/bin/env python3
"""
Test single person simulation via API with detailed error reporting
"""
...
print("Testing Single Person Simulation with error details...")
print(f"include_partner: {payload['include_partner']}")
print()

# First, let's check if the API can handle the request
...
if response.status_code == 200:
    ...
    if data.get('success'):
        print("\n✅ SUCCESS! Single person simulation worked!")
        ...
        print("\n⚠️ Check API logs for full traceback:")
        print("  Run: tail -n 50 python-api/api.log")
