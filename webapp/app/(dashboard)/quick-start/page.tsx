        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Just 4 quick questions to get started. Takes less than 1 minute.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Your current take-home income per month</p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>This quick start gets you a basic projection. You can refine it anytime by adding assets, expenses, and other details from your dashboard.</p>
                </div>
              </div>
            </div>
