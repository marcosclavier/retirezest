/**
 * Test script to verify simulation works for age 65 to 70
 * Usage: node scripts/test-simulation-70.js
 */

async function testSimulation() {
  try {
    console.log('🔍 Testing simulation for age 65 to 70 (5-year horizon)...\n');

    // Test data with someone age 65 planning to age 70
    const testData = {
      household_input: {
        p1: {
          name: "Test User",
        ...
        province: "AB",
        start_year: 2025,
        end_age: 70, // Testing with very short horizon
    ...
    console.log('Planning horizon:', testData.household_input.end_age - testData.household_input.p1.start_age + 1, 'years');
    ...
    if (response.ok && data.success) {
      console.log('✅ Simulation successful for 5-year horizon (65 to 70)!');
