/**
 * Test script to verify simulation works with life expectancy of 80
 * Usage: node scripts/test-simulation-80.js
 */

async function testSimulation() {
  try {
    console.log('🔍 Testing simulation with life expectancy of 80...\n');

    // Test data with end_age = 80
    const testData = {
      household_input: {
        p1: {
          name: "Test User",
        ...
        province: "AB",
        start_year: 2025,
        end_age: 80, // Testing with life expectancy of 80
    ...
    console.log('End age (life expectancy):', testData.household_input.end_age);
    ...
    if (response.ok && data.success) {
      console.log('✅ Simulation successful with life expectancy of 80!');
