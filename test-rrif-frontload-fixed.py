#!/usr/bin/env python3
"""
Fixed comprehensive test suite for RRIF-frontload strategy
"""
import requests
import json
import sys
...
def test_rrif_percentage():
    ...
    for test in test_cases:
        # Build payload WITHOUT p2 field for single person
        payload = {
            'p1': {
                'name': 'Test',
                'start_age': test['age'],
...
def test_withdrawal_order():
    ...
    # Test with limited corporate to force NonReg use - single person WITHOUT p2 field
    payload = {
        'p1': {
            'name': 'Test1',
            'start_age': 65,
